...
/**
 * REST controller for managing {@link com.tfg.inmobiliaria.domain.Servicio}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ServicioResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/servicios/{id}", consumes = "application/merge-patch+json")
        ...
        Optional<Servicio> result = servicioRepository
            ...
            .map(
                existingServicio -> {
                    ...
                    if (servicio.getPrecioHoras() != null) {
                        existingServicio.setPrecioHoras(servicio.getPrecioHoras());
                    }
                    if (servicio.getHoras() != null) {
                        existingServicio.setHoras(servicio.getHoras());
                    }

...
/**
 * REST controller for managing {@link com.tfg.inmobiliaria.domain.Contrato}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ContratoResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/contratoes/{id}", consumes = "application/merge-patch+json")
        ...
        Optional<Contrato> result = contratoRepository
            ...
            .map(
                existingContrato -> {
                    ...
                    if (contrato.getPrecioAlquiler() != null) {
                        existingContrato.setPrecioAlquiler(contrato.getPrecioAlquiler());
                    }

  ...
  describe('Contrato Service', () => {
    ...
    describe('Service methods', () => {
        ...
        const returnedFromService = Object.assign(
          {
            ...
            precioAlquiler: currentDate.format(DATE_FORMAT),
          },
          elemDefault
        );
      ...
      it('should partial update a Contrato', () => {
        const patchObject = Object.assign({}, new Contrato());
      ...
      describe('addContratoToCollectionIfMissing', () => {
        ...
        it('should add only unique Contrato to an array', () => {
          const contratoArray: IContrato[] = [{ id: 123 }, { id: 456 }, { id: 12857 }];

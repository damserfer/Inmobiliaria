...
import com.tfg.inmobiliaria.repository.ContratoRepository;
...
class ContratoResourceIT {
    ...
    private static final LocalDate DEFAULT_PRECIO_ALQUILER = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_PRECIO_ALQUILER = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Contrato createEntity(EntityManager em) {
        Contrato contrato = new Contrato()
            ...
            .precioAlquiler(DEFAULT_PRECIO_ALQUILER);
        return contrato;
    }
    ...
    public static Contrato createUpdatedEntity(EntityManager em) {
        Contrato contrato = new Contrato()
            ...
            .precioAlquiler(UPDATED_PRECIO_ALQUILER);
        return contrato;
    }
    ...
    void createContrato() throws Exception {
        ...
        assertThat(testContrato.getPrecioAlquiler()).isEqualTo(DEFAULT_PRECIO_ALQUILER);
    }
    ...
    void getAllContratoes() throws Exception {
        ...
        restContratoMockMvc
            ...
            .andExpect(jsonPath("$.[*].precioAlquiler").value(hasItem(DEFAULT_PRECIO_ALQUILER.toString())));
    }
    ...
    void getContrato() throws Exception {
        ...
        restContratoMockMvc
            ...
            .andExpect(jsonPath("$.precioAlquiler").value(DEFAULT_PRECIO_ALQUILER.toString()));
    }
    ...
    void putNewContrato() throws Exception {
        ...
        updatedContrato.fechaInicio(UPDATED_FECHA_INICIO).fechaFin(UPDATED_FECHA_FIN).precioAlquiler(UPDATED_PRECIO_ALQUILER);
        ...
        assertThat(testContrato.getPrecioAlquiler()).isEqualTo(UPDATED_PRECIO_ALQUILER);
    }
    ...
    void fullUpdateContratoWithPatch() throws Exception {
        ...
        partialUpdatedContrato.fechaInicio(UPDATED_FECHA_INICIO).fechaFin(UPDATED_FECHA_FIN).precioAlquiler(UPDATED_PRECIO_ALQUILER);
